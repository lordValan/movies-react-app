...
const server_responses = {
    ...
    DUPLICATED_IMPORT_MOVIE: 'One of the movies is already in the list. Please, remove it from the file and try again.',
    DUPLICATED_MOVIE: 'This movie is already in the list!',
